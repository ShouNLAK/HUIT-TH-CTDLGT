...
void showMenu()
{
	...
	printf("\n* 18. Xoa phan tu dau tien cua danh sach                         *");
	printf("\n* 19. Xoa phan tu cuoi cung cua danh sach                        *");
	printf("\n* 20. Xoa phan tu ke truoc cua danh sach                         *");
	printf("\n* 21. Xoa phan tu ke sau cua danh sach                         *");
	printf("\n******************************************************************");
}
//==============================================================
void process()
{
	...
	do
	{
		...
		case 18:
			...
			if (kq == 1)
			{
				printf("\nNOI DUNG DANH SACH SAU KHI XOA PHAN TU DAU DANH SACH LA : \n");
				showSList(SL);
			}
			else
			{
				printf("\nKhong the xoa phan tu dau danh sach.");
			}
			break;
		case 19:
			kq = deleteTail(SL, X);
			if (kq == 1)
			{
				printf("\nNOI DUNG DANH SACH SAU KHI XOA PHAN TU CUOI DANH SACH LA : \n");
				showSList(SL);
			}
			else
			{
				printf("\nKhong the xoa phan tu cuoi danh sach.");
			}
			break;
		case 20:
			printf("Nhap gia tri node ke sau node muon xoa : ");
			scanf("%d", &Y);
			Q = findSNode(SL, Y);
			kq = deleteBefore(SL, Q,X);
			if (kq == 1)
			{
				printf("\nNOI DUNG DANH SACH SAU KHI XOA PHAN TU %d SAU %d DANH SACH LA : \n",X,Y);
				showSList(SL);
			}
			else
			{
				printf("\nKhong the xoa phan tu ke truoc %d danh sach.",Y);
			}
			break;
		case 21:
			printf("Nhap gia tri node ke truoc node muon xoa : ");
			scanf("%d", &Y);
			Q = findSNode(SL, Y);
			kq = deleteAfter(SL, Q, X);
			if (kq == 1)
			{
				printf("\nNOI DUNG DANH SACH SAU KHI XOA PHAN TU %d TRUOC %d DANH SACH LA : \n", X, Y);
				showSList(SL);
			}
			else
			{
				printf("\nKhong the xoa phan tu ke sau %d danh sach.", Y);
			}
			break;
		}
	} while (luaChon != 0);
